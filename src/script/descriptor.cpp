...
public:
    ...
    TimeLockManager GetTimeLocks(uint32_t max_locktime_height, uint32_t max_locktime_mtp, uint32_t max_sequence_depth) const final {
        return m_subdescriptor_args.at(0)->GetTimeLocks(max_locktime_height, max_locktime_mtp, max_sequence_depth);
    }
};
...
public:
    ...
    TimeLockManager GetTimeLocks(uint32_t max_locktime_height, uint32_t max_locktime_mtp, uint32_t max_sequence_depth) const final {
        return m_node->GetTimeLocks(max_locktime_height, max_locktime_mtp, max_sequence_depth);
    }
};
