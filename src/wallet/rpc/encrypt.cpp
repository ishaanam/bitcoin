            ...
            "time that overrides the old one.\n",
                {
                    ...
                    {"timeout", RPCArg::Type::NUM, RPCArg::Optional::NO, "The time to keep the decryption key in seconds; capped at 100000000 (~3 years). If the timeout is set to 0, then the wallet is not automatically locked, and instead `walletlock` must be called to lock it."},
                },
